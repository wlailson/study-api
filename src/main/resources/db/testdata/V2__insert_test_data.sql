...
VALUES ('Maria Silva', 'maria@gmail.com', '$2a$12$XNDYRKncWl1260k8BNBIdOC5BexfIu/fWscpjYbRL2xoLUVR/6KLu', '61996695658',
        '1997-11-01');

INSERT INTO tb_user (name, email, password, phone, birth_date)
VALUES ('João Santos', 'joao@gmail.com', '$2a$12$XNDYRKncWl1260k8BNBIdOC5BexfIu/fWscpjYbRL2xoLUVR/6KLu', '61991234567',
        '1995-05-15');

INSERT INTO tb_user (name, email, password, phone, birth_date)
VALUES ('Ana Oliveira', 'ana@gmail.com', '$2a$12$XNDYRKncWl1260k8BNBIdOC5BexfIu/fWscpjYbRL2xoLUVR/6KLu', '61999887766',
        '2000-08-20');

INSERT INTO tb_user (name, email, password, phone, birth_date)
VALUES ('Carlos Almeida', 'carlos@gmail.com', '$2a$12$XNDYRKncWl1260k8BNBIdOC5BexfIu/fWscpjYbRL2xoLUVR/6KLu',
        '61997766554', '1992-03-10');
...
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (1, 1, 'Herança', 60, 10, 'COMPLETED',
        '2026-09-07 10:00:00', '2026-09-07 12:00:00');

INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (1, 1, 'Polimorfismo', 90, 15, 'COMPLETED',
        '2026-09-07 14:00:00', '2026-09-07 15:45:00');

INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (1, 2, 'Injeção de Dependência', 120, 20, 'COMPLETED',
        '2026-09-08 09:00:00', '2026-09-08 11:20:00');

INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (1, 3, 'Relacionamentos JPA', 60, 10, 'IN_PROGRESS',
        '2026-09-08 15:00:00', NULL);

-- STUDY SESSIONS - JOÃO
INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (2, 4, 'Promises e Async/Await', 90, 15, 'COMPLETED',
        '2026-09-07 09:00:00', '2026-09-07 10:45:00');

INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (2, 5, 'Componentes', 120, 20, 'COMPLETED',
...
INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (3, 7, 'Listas e Dicionários', 60, 10, 'COMPLETED',
        '2026-09-07 08:00:00', '2026-09-07 09:10:00');

INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (3, 8, 'Regressão Linear', 120, 20, 'COMPLETED',
...
INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (4, 9, 'Streams', 90, 15, 'COMPLETED',
        '2026-09-07 19:00:00', '2026-09-07 20:45:00');

INSERT INTO tb_study_session
(user_id, subject_id, topic, duration_in_minutes, break_time_in_minutes, status, start_time, end_time)
VALUES (4, 10, 'Clean Architecture', 120, 20, 'COMPLETED',
